...
<div class="container-fluid bg-3 text-center">    
 ...
 <div class='main-container'>
     ...
     <div class='control'>
         ...
         <p><input type="button" style="height: 50px; width: 275px;margin-bottom: 15px;color:white;background-color: orangered;" value="PLAY AGAIN" onclick='refreshPage()' />
     </div>
 </div>
